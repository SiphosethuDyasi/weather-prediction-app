...
import { ForecastParams, HomeScreenProps, LocationParams, WeatherForecast, Location } from '@/constants/types';
...
import { fetchLocations, fetchWeatherForecast } from '@/api/weather-api';
...
const HomeScreen: React.FC<HomeScreenProps> = ({navigation, route}: any) => {
